...
func (c *client) Dial(
	...
	return newConnection(conn, maxAgeTime, c.config.OperationTimeout, c.config.DrainTimeout)
}
...
func (c *client) DialTLS(
	...
	return newConnection(tlsConn, maxAgeTime, c.config.OperationTimeout, c.config.DrainTimeout)
}
